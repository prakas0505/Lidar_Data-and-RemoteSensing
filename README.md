...
Derive structural metrics — vertical profiles, mean/quadratic mean canopy height, height quantiles, canopy cover, gap fraction — at both the point-cloud and CHM level.
...
Simulate synthetic LiDAR point clouds and waveforms from forest inventory data (tree positions, DBH, crown geometry) using a Beer-Lambert light-extinction model — useful for testing algorithms against a known "ground truth" forest.
